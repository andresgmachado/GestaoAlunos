...
namespace GestaoAlunos.Data
{
    public class Dbinitializer
    {

        public static void Initializer(EscolaContexto _context)
        {
            _context.Database.EnsureCreated();

            if(_context.Estudantes.Any())
            { 
                return;
            }
